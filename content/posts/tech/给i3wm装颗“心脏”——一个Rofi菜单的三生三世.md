...
lastmod = "2026-08-11T23:05:00+08:00"
...
我用的是 [i3wm](https://i3wm.org)——平铺式，轻量、配置清晰、功能丰富而恰到好处。相关配置可查阅 [AllenWu233/dotfiles](https://github.com/AllenWu233/dotfiles)。如下图所示：

![i3wm](rofi-heart-fastfetch.png)
...
![rofi-heart-main](rofi-heart-main.jpg)

![rofi-heart-emoji](rofi-heart-emoji.jpg)

代码清晰易懂，像在 Shell 里输命令一样直白。但维护起来就很难受：修改一个脚本，就要同时改`items`、`choice`、`case` 三处，效率低下且易出错。

像电源菜单这样写好了就基本不改的脚本，这个版本很合适。但 rofi-heart 要频繁维护子脚本项，显然不好用。

### 第二世：束薪为栅

第一版的 Shell 维护起来这么麻烦，有没有办法把所有相关配置放在开头呢？
...
4. [heart - gununixchad/dotfiles](https://github.com/gnuunixchad/dotfiles/blob/master/.local/bin/heart)
